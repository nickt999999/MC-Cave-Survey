...
execute unless score @s survey.general.uninstall_timer matches 1..300 run tellraw @s [{"text":"["},{"text":"SURVEY","color":"red"},{"text":"] Uninstall cave survey datapack? Re-ender command to confirm"}]
...
execute if score @s survey.general.uninstall_timer matches 1..300 run function survey:general/uninstall
# update confirm timer
execute unless score @s survey.general.uninstall_timer matches 1..300 run scoreboard players set @s survey.general.uninstall_timer 300
