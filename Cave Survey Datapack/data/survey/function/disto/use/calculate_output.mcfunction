...
# apply rotation
execute if items entity @s weapon.* carrot_on_a_stick[custom_data~{"backsight_mode":0b}] run scoreboard players add #survey disto_azimuth 180000
execute if items entity @s weapon.* carrot_on_a_stick[custom_data~{"backsight_mode":1b}] if score #survey disto_azimuth matches -180000..-1 run scoreboard players add #survey disto_azimuth 360000
