...
execute if score #survey survey.disto.inclination matches -2147483648..0 run scoreboard players operation #survey survey.disto.inclination_abs *= #survey survey.general.-1
...
scoreboard players operation #survey survey.disto.inclination_decimal_3 %= #survey survey.general.10
...
scoreboard players operation #survey survey.disto.inclination_whole /= #survey survey.general.1000
execute if score #survey survey.disto.inclination matches -2147483648..0 run scoreboard players operation #survey survey.disto.inclination_whole *= #survey survey.general.-1
scoreboard players operation #survey survey.disto.inclination_decimal_1 = #survey survey.disto.inclination_abs 
scoreboard players operation #survey survey.disto.inclination_decimal_1 %= #survey survey.general.1000
scoreboard players operation #survey survey.disto.inclination_decimal_1 /= #survey survey.general.100
scoreboard players operation #survey survey.disto.inclination_decimal_2 = #survey survey.disto.inclination_abs 
scoreboard players operation #survey survey.disto.inclination_decimal_2 %= #survey survey.general.100
scoreboard players operation #survey survey.disto.inclination_decimal_2 /= #survey survey.general.10
...
scoreboard players operation #survey survey.disto.azimuth_decimal_3 %= #survey survey.general.10
...
scoreboard players operation #survey survey.disto.azimuth_whole /= #survey survey.general.1000
scoreboard players operation #survey survey.disto.azimuth_decimal_1 = #survey survey.disto.azimuth
scoreboard players operation #survey survey.disto.azimuth_decimal_1 %= #survey survey.general.1000
scoreboard players operation #survey survey.disto.azimuth_decimal_1 /= #survey survey.general.100
scoreboard players operation #survey survey.disto.azimuth_decimal_2 = #survey survey.disto.azimuth
scoreboard players operation #survey survey.disto.azimuth_decimal_2 %= #survey survey.general.100
scoreboard players operation #survey survey.disto.azimuth_decimal_2 /= #survey survey.general.10
...
scoreboard players operation #survey survey.disto.forwards_distance *= #survey survey.general.100
...
scoreboard players operation #survey survey.disto.distance_decimal_3 %= #survey survey.general.10
...
scoreboard players operation #survey survey.disto.distance_whole /= #survey survey.general.1000
scoreboard players operation #survey survey.disto.distance_decimal_1 = #survey survey.disto.distance
scoreboard players operation #survey survey.disto.distance_decimal_1 %= #survey survey.general.1000
scoreboard players operation #survey survey.disto.distance_decimal_1 /= #survey survey.general.100
scoreboard players operation #survey survey.disto.distance_decimal_2 = #survey survey.disto.distance
scoreboard players operation #survey survey.disto.distance_decimal_2 %= #survey survey.general.100
scoreboard players operation #survey survey.disto.distance_decimal_2 /= #survey survey.general.10