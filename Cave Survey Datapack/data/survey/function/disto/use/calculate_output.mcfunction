# get shot inclination
execute if items entity @s weapon.* carrot_on_a_stick[custom_data~{"backsight_mode":0b}] store result score #survey disto_inclination run data get entity @e[tag=disto_origin_pos,limit=1,type=marker,distance=..4] Rotation[1] -1000
execute if items entity @s weapon.* carrot_on_a_stick[custom_data~{"backsight_mode":1b}] store result score #survey disto_inclination run data get entity @e[tag=disto_origin_pos,limit=1,type=marker,distance=..4] Rotation[1] 1000
...
# calculate 0deg-360deg range azimuth
execute if items entity @s weapon.* carrot_on_a_stick[custom_data~{"backsight_mode":0b}] if score #survey disto_azimuth matches -180000..-1 run scoreboard players add #survey disto_azimuth 360000
execute if items entity @s weapon.* carrot_on_a_stick[custom_data~{"backsight_mode":1b}] run scoreboard players add #survey disto_azimuth 180000
