...
execute if entity @s[tag=disto_mainhand] if items entity @s weapon.offhand minecraft:music_disc_lava_chicken[minecraft:custom_data~{disto:1b}] if score @s survey.disto.swaphands_timer matches 0 run scoreboard players set @s survey.disto.swaphands_timer 5
execute if entity @s[tag=disto_offhand] if items entity @s weapon.mainhand minecraft:music_disc_lava_chicken[minecraft:custom_data~{disto:1b}] if score @s survey.disto.swaphands_timer matches 0 run scoreboard players set @s survey.disto.swaphands_timer 5

# return true if player swaps hands within 5 ticks (2nd time)
execute if entity @s[tag=disto_mainhand] if items entity @s weapon.offhand minecraft:music_disc_lava_chicken[minecraft:custom_data~{disto:1b}] if score @s survey.disto.swaphands_timer matches 1..4 if score @s survey.disto.change_backsight_mode_timer matches 0 run return 1
execute if entity @s[tag=disto_offhand] if items entity @s weapon.mainhand minecraft:music_disc_lava_chicken[minecraft:custom_data~{disto:1b}] if score @s survey.disto.swaphands_timer matches 1..4 if score @s survey.disto.change_backsight_mode_timer matches 0 run return 1

# restart 10 tick change backsight mode timer if player attempts to double swaphands again within 10 ticks
execute if entity @s[tag=disto_mainhand] if items entity @s weapon.offhand minecraft:music_disc_lava_chicken[minecraft:custom_data~{disto:1b}] if score @s survey.disto.swaphands_timer matches 1..4 run scoreboard players set @s survey.disto.change_backsight_mode_timer 10
execute if entity @s[tag=disto_offhand] if items entity @s weapon.mainhand minecraft:music_disc_lava_chicken[minecraft:custom_data~{disto:1b}] if score @s survey.disto.swaphands_timer matches 1..4 run scoreboard players set @s survey.disto.change_backsight_mode_timer 10
