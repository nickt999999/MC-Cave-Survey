...
execute store result storage survey:data disto.id.slot int 1 run data get entity @s Inventory[{id:"carrot_on_a_stick",components:{"minecraft:custom_data":{disto:1b,disto_id:0b}}}].Slot
