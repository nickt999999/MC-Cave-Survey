...
$item replace entity @s weapon.$(slot) with music_disc_lava_chicken[!minecraft:jukebox_playable,minecraft:consumable={consume_seconds:2147483647},minecraft:item_name={text:"Disto™ X310","color":"white"},minecraft:item_model="survey:disto",minecraft:custom_data={disto:1b,disto_id:$(disto_id),backsight_mode:$(new_mode)b,survey:1b}]
