...
execute store result storage survey:data flagging_tape.text_check.length.index int 1 run scoreboard players get #survey survey.flagging_tape.char_start_index
...
execute if score #survey survey.flagging_tape.char_start_index matches 13 run return 0
# loop function
